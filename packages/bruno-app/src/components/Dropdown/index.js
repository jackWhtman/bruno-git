...
const Dropdown = ({ icon, children, onCreate, placement, transparent, visible, appendTo, onMouseEnter, onMouseLeave, className, ...props }) => {
  ...
  return (
    <Tippy
      render={(attrs) => (
        <StyledWrapper
          className={`tippy-box dropdown ${className || ''}`.trim()}
